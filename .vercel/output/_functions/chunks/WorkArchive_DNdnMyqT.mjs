...
}, "C:/ASTRO/template2/src/components/portfolio/ProjectCard.astro", void 0);
//#endregion
...
var $$WorkArchive = createComponent(($$result, $$props, $$slots) => {
	...
	return renderTemplate`${maybeRenderHead($$result)}<section class="work-hero" aria-labelledby="work-title" data-astro-cid-4bg4ncfp>${renderComponent($$result, "Container", $$Container, {
		...
		"basePath": "/work",
		"data-astro-cid-4bg4ncfp": true
	})}` })}` : renderTemplate`<p class="empty-state" data-astro-cid-4bg4ncfp>Galeri paket sedang disusun. Silakan kunjungi kembali nanti.</p>`}` })}</section>${renderScript($$result, "C:/ASTRO/template2/src/components/portfolio/WorkArchive.astro?astro&type=script&index=0&lang.ts")}`;
}, "C:/ASTRO/template2/src/components/portfolio/WorkArchive.astro", void 0);
//#endregion
